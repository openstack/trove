...
common_opts = [
    ...
    cfg.StrOpt('cinder_client_version', default='3',
               help="The version of the volume service client."),
    ...
    cfg.StrOpt('trove_endpoint_type', default='publicURL',
               help='Service endpoint type to use when searching catalog.'),
    cfg.URIOpt('barbican_url', help='URL ending in ``AUTH_``.'),
    cfg.StrOpt('barbican_service_type', default='key-manager',
               help='Service type to use when fetching keys.'),
    cfg.StrOpt('barbican_endpoint_type', default='publicURL',
               help='Service endpoint type to use when fetching keys.'),
    ...
    cfg.IntOpt('running_backups_expires', default=3,
               help='Number of days after hanging backups can be deleted.'),
